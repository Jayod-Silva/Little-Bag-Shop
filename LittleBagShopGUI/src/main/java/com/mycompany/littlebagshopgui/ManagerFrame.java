...
public class ManagerFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSearchBagsByCategory = new javax.swing.JButton();
        txtSearchBagByCategory = new javax.swing.JTextField();
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 420, 80, 30));
        ...
        btnSearchBagsByCategory.setBackground(new java.awt.Color(0, 102, 102));
        btnSearchBagsByCategory.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnSearchBagsByCategory.setForeground(new java.awt.Color(255, 255, 255));
        btnSearchBagsByCategory.setText("Search");
        btnSearchBagsByCategory.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnSearchBagsByCategory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSearchBagsByCategoryActionPerformed(evt);
            }
        });
        jPanel1.add(btnSearchBagsByCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 130, -1, 30));

        txtSearchBagByCategory.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(113, 175, 236)));
        jPanel1.add(txtSearchBagByCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, 160, 30));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("Search Bags");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 90, -1, -1));

        btnCreateNewUser.setBackground(new java.awt.Color(0, 102, 102));
        btnCreateNewUser.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnCreateNewUser.setForeground(new java.awt.Color(255, 255, 255));
        btnCreateNewUser.setText("Create New User");
        btnCreateNewUser.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnCreateNewUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCreateNewUserActionPerformed(evt);
            }
        });
        jPanel1.add(btnCreateNewUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, -1, 30));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/manager image.png"))); // NOI18N
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 170, 470, 300));
    ...
    private void btnSearchBagsByCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchBagsByCategoryActionPerformed
        try
        {
            boolean found = true;
            String[] BagData = null;
            ...
            String FindLine;
            String SearchCategory = txtSearchBagByCategory.getText();
            ...
            if(found)
            {
                ...
                JOptionPane.showMessageDialog(rootPane,message,"Input Success!!",JOptionPane.INFORMATION_MESSAGE);
            }
            else
            {
                JOptionPane.showMessageDialog(rootPane, "Data not found! ","Input Error",JOptionPane.ERROR_MESSAGE);
            }

        }
        catch(IOException ex){

            JOptionPane.showMessageDialog(rootPane, "Search error! Please try again","Error",JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_btnSearchBagsByCategoryActionPerformed
    ...
    private javax.swing.JButton btnSearchBagsByCategory;
    ...
    private javax.swing.JTextField txtSearchBagByCategory;
